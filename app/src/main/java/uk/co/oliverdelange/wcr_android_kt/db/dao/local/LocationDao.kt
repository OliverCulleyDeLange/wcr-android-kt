...
interface LocationDao : BaseDao<Location> {
    ...
    fun loadWithParentId(parent: Long, type: String = "SECTOR"): LiveData<List<Location>>
    ...
    override fun updateUploadedAt(id: Long, uploadedAt: Long): Completable

    @Query("SELECT * FROM location where type = :type AND parentLocationId = :parent")
    fun getWithParentId(parent: Long, type: String = "SECTOR"): List<Location>
    ...
    fun getRouteInfo(id: Long): LiveData<LocationRouteInfo>
}